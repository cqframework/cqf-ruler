...
public interface ResolutionUtilities {
	...
	default <ResourceType extends IBaseResource> ResourceType resolveById(
		...
		IIdType id = Ids.newId(theResourceDao.getContext(), theId);
	...
	default <ResourceType extends IBaseResource> ResourceType resolveByNameAndVersion(
		...
		return Versions.selectByVersion(resources, theVersion, Reflections.getVersionFunction(theResourceDao.getResourceType()));
	}
	...
	default <ResourceType extends IBaseResource> ResourceType resolveByCanonicalUrl(
		...
		return Versions.selectByVersion(resources, version, Reflections.getVersionFunction(theResourceDao.getResourceType()));
	}
