...
import org.opencds.cqf.dstu3.qdm.conversion.model.Patient;
import org.opencds.cqf.dstu3.qdm.conversion.model.Ratio;
...
public class QdmDataProvider extends JpaDataProvider {
    ...
    public QdmDataProvider(Collection<IResourceProvider> providers) {
        super(providers);
        setPackageName("org.opencds.cqf.dstu3.qdm.conversion.model");
