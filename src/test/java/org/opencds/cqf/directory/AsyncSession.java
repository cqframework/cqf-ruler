...
//        this.httpServiceResponse = httpServletResponse;
    ...
    public boolean hasError() {
        return asyncResult.getOperationOutcome()!=null;
    }

    public OperationOutcome getOperationOutcome() {
        return asyncResult.getOperationOutcome();
    }
        ...
        public synchronized void run() {
            ...
            try {
                ...
                if ( iBaseResource instanceof OperationOutcome) {
                    ...
                    isDone = true;
                    AsyncHelper.logger.info("Async processing done - error response");
                    asyncResult.addOperationOutcome( (OperationOutcome)iBaseResource );
    ...
    public static void processBundle(AsyncResult asyncResult, Bundle bundle, HashMap<String, String> headerValues) {
