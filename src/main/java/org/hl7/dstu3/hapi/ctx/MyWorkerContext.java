...
public final class MyWorkerContext implements IWorkerContext, ValueSetExpander, ValueSetExpanderFactory {
    ...
    public MyWorkerContext(FhirContext theCtx, IValidationSupport theValidationSupport) {
