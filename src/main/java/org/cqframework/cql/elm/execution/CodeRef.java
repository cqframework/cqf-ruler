...
@XmlType(name = "CodeRef", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public CodeRef withName(String value) {
        setName(value);
        return this;
    }

    public CodeRef withLibraryName(String value) {
        setLibraryName(value);
        return this;
    }

    @Override
    public CodeRef withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public CodeRef withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public CodeRef withLocalId(String value) {
        setLocalId(value);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final CodeRef that = ((CodeRef) object);
        {
            String lhsName;
