...
@XmlType(name = "ConceptRef", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public ConceptRef withName(String value) {
        setName(value);
        return this;
    }

    public ConceptRef withLibraryName(String value) {
        setLibraryName(value);
        return this;
    }

    @Override
    public ConceptRef withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public ConceptRef withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public ConceptRef withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ConceptRef)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ConceptRef that = ((ConceptRef) object);
        {
            String lhsName;
