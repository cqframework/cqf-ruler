...
public class NegativeAssessmentPerformedController implements Serializable
{
    ...
    public List<NegativeAssessmentPerformed> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            NegativeAssessmentPerformed exampleType = new NegativeAssessmentPerformed();
            Id pId = new Id();
            ...
            Example<NegativeAssessmentPerformed> example = Example.of(exampleType, matcher);
