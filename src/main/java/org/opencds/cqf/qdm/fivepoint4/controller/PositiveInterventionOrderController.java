...
public class PositiveInterventionOrderController implements Serializable
{
    ...
    public List<PositiveInterventionOrder> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveInterventionOrder exampleType = new PositiveInterventionOrder();
            Id pId = new Id();
            ...
            Example<PositiveInterventionOrder> example = Example.of(exampleType, matcher);
