...
public class PositiveAssessmentRecommendedController implements Serializable
{
    ...
    public List<PositiveAssessmentRecommended> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveAssessmentRecommended exampleType = new PositiveAssessmentRecommended();
            Id pId = new Id();
            ...
            Example<PositiveAssessmentRecommended> example = Example.of(exampleType, matcher);
