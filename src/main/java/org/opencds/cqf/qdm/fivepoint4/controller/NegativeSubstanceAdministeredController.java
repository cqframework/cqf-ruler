...
public class NegativeSubstanceAdministeredController implements Serializable
{
    ...
    public List<NegativeSubstanceAdministered> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            NegativeSubstanceAdministered exampleType = new NegativeSubstanceAdministered();
            Id pId = new Id();
            ...
            Example<NegativeSubstanceAdministered> example = Example.of(exampleType, matcher);
