...
public abstract class AssessmentRecommended extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof AssessmentRecommended)
        {
            AssessmentRecommended assessmentRecommended = (AssessmentRecommended) other;
            super.copy(assessmentRecommended);
            setAuthorDatetime(assessmentRecommended.getAuthorDatetime());
            setNegationRationale(assessmentRecommended.getNegationRationale());
            setReason(assessmentRecommended.getReason());
        }
        else
        {
