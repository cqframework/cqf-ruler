...
public abstract class InterventionRecommended extends BaseType implements Serializable
{
   ...
   @ElementCollection
    ...
    {
        if (other instanceof InterventionRecommended)
        {
            InterventionRecommended interventionRecommended = (InterventionRecommended) other;
            super.copy(interventionRecommended);
            setAuthorDatetime(interventionRecommended.getAuthorDatetime());
            setReason(interventionRecommended.getReason());
            setFacilityLocation(interventionRecommended.getFacilityLocation());
            setNegationRationale(interventionRecommended.getNegationRationale());
        }
        else
        {
