...
public abstract class ImmunizationOrder extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof ImmunizationOrder)
        {
            ImmunizationOrder interventionPerformed = (ImmunizationOrder) other;
            super.copy(interventionPerformed);
            setActiveDatetime(interventionPerformed.getActiveDatetime());
            setAuthorDatetime(interventionPerformed.getAuthorDatetime());
            setDosage(interventionPerformed.getDosage());
            setSupply(interventionPerformed.getSupply());
