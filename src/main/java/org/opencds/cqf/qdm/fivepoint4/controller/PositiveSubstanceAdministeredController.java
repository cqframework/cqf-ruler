...
public class PositiveSubstanceAdministeredController implements Serializable
{
    ...
    public List<PositiveSubstanceAdministered> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveSubstanceAdministered exampleType = new PositiveSubstanceAdministered();
            Id pId = new Id();
            ...
            Example<PositiveSubstanceAdministered> example = Example.of(exampleType, matcher);
