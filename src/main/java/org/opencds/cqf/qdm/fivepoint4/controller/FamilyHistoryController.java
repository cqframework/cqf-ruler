...
public class FamilyHistoryController implements Serializable
{
    ...
    public List<FamilyHistory> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            FamilyHistory exampleType = new FamilyHistory();
            Id pId = new Id();
            ...
            Example<FamilyHistory> example = Example.of(exampleType, matcher);
