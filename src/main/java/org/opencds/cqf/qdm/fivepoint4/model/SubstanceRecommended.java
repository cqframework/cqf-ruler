...
public abstract class SubstanceRecommended extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof SubstanceRecommended)
        {
            SubstanceRecommended substanceOrder = (SubstanceRecommended) other;
