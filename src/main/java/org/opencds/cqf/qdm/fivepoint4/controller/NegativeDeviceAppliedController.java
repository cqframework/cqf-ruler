...
public class NegativeDeviceAppliedController implements Serializable
{
    ...
    public List<NegativeDeviceApplied> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            NegativeDeviceApplied exampleType = new NegativeDeviceApplied();
            Id pId = new Id();
            ...
            Example<NegativeDeviceApplied> example = Example.of(exampleType, matcher);
