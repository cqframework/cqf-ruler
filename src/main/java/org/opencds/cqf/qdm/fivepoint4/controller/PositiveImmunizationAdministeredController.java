...
public class PositiveImmunizationAdministeredController implements Serializable
{
    ...
    public List<PositiveImmunizationAdministered> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveImmunizationAdministered exampleType = new PositiveImmunizationAdministered();
            Id pId = new Id();
            ...
            Example<PositiveImmunizationAdministered> example = Example.of(exampleType, matcher);
