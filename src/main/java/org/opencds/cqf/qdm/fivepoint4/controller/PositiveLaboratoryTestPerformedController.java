...
public class PositiveLaboratoryTestPerformedController implements Serializable
{
    ...
    public List<PositiveLaboratoryTestPerformed> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveLaboratoryTestPerformed exampleType = new PositiveLaboratoryTestPerformed();
            Id pId = new Id();
            ...
            Example<PositiveLaboratoryTestPerformed> example = Example.of(exampleType, matcher);
