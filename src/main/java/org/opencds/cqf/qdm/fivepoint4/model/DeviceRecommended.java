...
public abstract class DeviceRecommended extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof DeviceRecommended)
        {
            DeviceRecommended deviceRecommended = (DeviceRecommended) other;
            super.copy(deviceRecommended);
            setAuthorDatetime(deviceRecommended.getAuthorDatetime());
            setNegationRationale(deviceRecommended.getNegationRationale());
            setReason(deviceRecommended.getReason());
        }
        else
        {
