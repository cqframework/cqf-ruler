...
public class PositiveProcedureRecommendedController implements Serializable
{
    ...
    public List<PositiveProcedureRecommended> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveProcedureRecommended exampleType = new PositiveProcedureRecommended();
            Id pId = new Id();
            ...
            Example<PositiveProcedureRecommended> example = Example.of(exampleType, matcher);
