...
public class PatientCareExperienceController implements Serializable
{
    ...
    public List<PatientCareExperience> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PatientCareExperience exampleType = new PatientCareExperience();
            Id pId = new Id();
            ...
            Example<PatientCareExperience> example = Example.of(exampleType, matcher);
