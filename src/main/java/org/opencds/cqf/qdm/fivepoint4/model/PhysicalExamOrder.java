...
public abstract class PhysicalExamOrder extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof PhysicalExamOrder)
        {
            PhysicalExamOrder physicalExamOrder = (PhysicalExamOrder) other;
            super.copy(physicalExamOrder);
            setAuthorDatetime(physicalExamOrder.getAuthorDatetime());
            setReason(physicalExamOrder.getReason());
            setAnatomicalLocationSite(physicalExamOrder.getAnatomicalLocationSite());
            setNegationRationale(physicalExamOrder.getNegationRationale());
        }
        else
        {
