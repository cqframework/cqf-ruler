...
public class AdverseEventController implements Serializable
{
    ...
    public List<AdverseEvent> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            AdverseEvent exampleType = new AdverseEvent();
            Id pId = new Id();
            ...
            Example<AdverseEvent> example = Example.of(exampleType, matcher);
