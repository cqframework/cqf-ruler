...
public class PositiveDeviceRecommendedController implements Serializable
{
    ...
    public List<PositiveDeviceRecommended> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveDeviceRecommended exampleType = new PositiveDeviceRecommended();
            Id pId = new Id();
            ...
            Example<PositiveDeviceRecommended> example = Example.of(exampleType, matcher);
