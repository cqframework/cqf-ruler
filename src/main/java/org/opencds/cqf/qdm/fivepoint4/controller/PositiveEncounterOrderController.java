...
public class PositiveEncounterOrderController implements Serializable
{
    ...
    public List<PositiveEncounterOrder> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveEncounterOrder exampleType = new PositiveEncounterOrder();
            Id pId = new Id();
            ...
            Example<PositiveEncounterOrder> example = Example.of(exampleType, matcher);
