...
import com.philips.research.connect.bmi.FhirValueSetter;
 ...
 * map generateMapFromMappings(StructureDefinition) - buildQuestionnaire a mapping from a structure definition with loigcal mappings
 *
...
public class StructureMapUtilities {
    ...
    private class FFHIRPathHostServices implements IEvaluationContext{
        ...
        public Base resolveConstant(Object appContext, String name) throws PathEngineException {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars = (org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables) appContext;
            Base res = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, name);
            if (res == null)
                res = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, name);
            return res;
        }

        @Override
        public TypeDetails resolveConstantType(Object appContext, String name) throws PathEngineException {
            if (!(appContext instanceof org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling))
                throw new Error("Internal Logic Error (wrong type '"+appContext.getClass().getName()+"' in resolveConstantType)");
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars = (org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling) appContext;
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling v = vars.get(null, name);
            if (v == null)
    ...
    private org.hl7.fhir.dstu3.utils.StructureMapUtilities.ITransformerServices services;
    private ProfileKnowledgeProvider pkp;
    private Map<String, Integer> ids = new HashMap<String, Integer>();

    public StructureMapUtilities(IWorkerContext worker, Map<String, StructureMap> library, org.hl7.fhir.dstu3.utils.StructureMapUtilities.ITransformerServices services, ProfileKnowledgeProvider pkp) {
        super();
        this.worker = worker;
        ...
        fpe.setHostServices(new org.hl7.fhir.dstu3.utils.StructureMapUtilities.FFHIRPathHostServices());
    }

    public StructureMapUtilities(IWorkerContext worker, Map<String, StructureMap> library, org.hl7.fhir.dstu3.utils.StructureMapUtilities.ITransformerServices services) {
        super();
        this.worker = worker;
        this.library = library;
        this.services = services;
    ...
    public StructureMapUtilities(IWorkerContext worker, org.hl7.fhir.dstu3.utils.StructureMapUtilities.ITransformerServices services) {
        super();
        this.worker = worker;
    ...
    public class Variable {
        ...
        private String name;
        private Base object;
        public Variable(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name, Base object) {
            super();
            this.mode = mode;
            this.name = name;
            this.object = object;
    ...
    public class Variables {
        private List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variable> list = new ArrayList<org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variable>();

        public void add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name, Base object) {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variable vv = null;
            for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variable v : list)
                if ((v.mode == mode) && v.getName().equals(name))
                    vv = v;
            if (vv != null)
                list.remove(vv);
            list.add(new org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variable(mode, name, object));
        }

        public org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables copy() {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables result = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables();
            result.list.addAll(list);
            return result;
        }

        public Base get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name) {
            for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variable v : list)
                if ((v.mode == mode) && v.getName().equals(name))
                    return v.getObject();
            return null;
        ...
        public String summary() {
            ...
            for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variable v : list)
                if (v.mode == org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT)
                    s.append(v.summary());
                else
                    t.append(v.summary());
    ...
    public void transform(Object appInfo, Base source, StructureMap map, Base target) throws FHIRException {
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext(appInfo);
        log("Start Transform "+map.getUrl());
        StructureMapGroupComponent g = map.getGroup().get(0);

        org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables();
        vars.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, getInputName(g, StructureMapInputMode.SOURCE, "source"), source);
        vars.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, getInputName(g, StructureMapInputMode.TARGET, "target"), target);
    ...
    private void executeGroup(String indent, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, StructureMapGroupComponent group) throws FHIRException {
        log(indent+"Group : "+group.getName());
        // todo: check inputs
        if (group.hasExtends()) {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup rg = resolveGroupReference(map, group, group.getExtends());
    ...
    private void executeRule(String indent, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, StructureMapGroupComponent group, StructureMapGroupRuleComponent rule) throws FHIRException {
        log(indent+"rule : "+rule.getName());
        if (rule.getName().contains("CarePlan.participant-unlink"))
            System.out.println("debug");
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables srcVars = vars.copy();
        if (rule.getSource().size() != 1)
            throw new FHIRException("Rule \""+rule.getName()+"\": not handled yet");
        List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables> source = processSource(rule.getName(), context, srcVars, rule.getSource().get(0));
        if (source != null) {
            for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables v : source) {
                ...
                if (rule.hasRule()) {
                    ...
                    Base src = v.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, rule.getSourceFirstRep().getVariable());
                    Base tgt = v.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, rule.getTargetFirstRep().getVariable());
                    String srcType = src.fhirType();
                    String tgtType = tgt.fhirType();
                    org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup defGroup = resolveGroupByTypes(map, rule.getName(), group, srcType, tgtType);
                    org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vdef = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables();
                    vdef.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, defGroup.target.getInput().get(0).getName(), src);
                    vdef.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, defGroup.target.getInput().get(1).getName(), tgt);
    ...
    private void executeDependency(String indent, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vin, StructureMapGroupComponent group, StructureMapGroupRuleDependentComponent dependent) throws FHIRException {
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup rg = resolveGroupReference(map, group, dependent.getName());
        ...
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables v = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables();
        for (int i = 0; i < rg.target.getInput().size(); i++) {
            ...
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode = input.getMode() == StructureMapInputMode.SOURCE ? org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT :   org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT;
            Base vv = vin.get(mode, var);
            if (vv == null && mode == org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT) //* once source, always source. but target can be treated as source at user convenient
                vv = vin.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, var);
            if (vv == null)
    ...
    private String determineTypeFromSourceType(StructureMap map, StructureMapGroupComponent source, Base base, String[] types) throws FHIRException {
        ...
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup res = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup();
        res.targetMap = null;
        res.target = null;
    ...
    private org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup resolveGroupByTypes(StructureMap map, String ruleid, StructureMapGroupComponent source, String srcType, String tgtType) throws FHIRException {
        String kn = "types^"+srcType+":"+tgtType;
        if (source.hasUserData(kn))
            return (org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup) source.getUserData(kn);
    ...
    private org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup resolveGroupReference(StructureMap map, StructureMapGroupComponent source, String name) throws FHIRException {
        String kn = "ref^"+name;
        if (source.hasUserData(kn))
            return (org.hl7.fhir.dstu3.utils.StructureMapUtilities.ResolvedGroup) source.getUserData(kn);
    ...
    private List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables> processSource(String ruleId, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, StructureMapGroupRuleSourceComponent src) throws FHIRException {
        List<Base> items;
        if (src.getContext().equals("@search")) {
            ...
            Base b = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, src.getContext());
            if (b == null)
        ...
        List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables> result = new ArrayList<org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables>();
        for (Base r : items) {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables v = vars.copy();
            if (src.hasVariable())
                v.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, src.getVariable(), r);
            result.add(v);
        }
        return result;
    }
    ...
    private void processTarget(String ruleId, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, StructureMap map, StructureMapGroupComponent group, StructureMapGroupRuleTargetComponent tgt, String srcVar) throws FHIRException {
        Base dest = null;
        if (tgt.hasContext()) {
            dest = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, tgt.getContext());
            if (dest == null)
        ...
        if (tgt.hasTransform()) {
            ...
            if (v != null && dest != null){
                FhirValueSetter.setProperty( dest, tgt.getElement(),v );
            }
//                v = dest.setProperty(tgt.getElement().hashCode(), tgt.getElement(), v); // reset v because some implementations may have to rewrite v when setting the value
        ...
        if (tgt.hasVariable() && v != null)
            vars.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, tgt.getVariable(), v);
    }

    private Base runTransform(String ruleId, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, StructureMapGroupComponent group, StructureMapGroupRuleTargetComponent tgt, org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, Base dest, String element, String srcVar) throws FHIRException {
        try {
                ...
                case CREATE :
                    ...
                    if (tgt.getParameter().isEmpty()) {
                        ...
                        if (types.length == 1 && !"*".equals(types[0]) && !types[0].equals("Resource"))
                            ...
                            tn = determineTypeFromSourceType(map, group, vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, srcVar), types);
                        } else
...
//	        res.setIdBase(tgt.getParameter().size() > 1 ? getParamString(vars, tgt.getParameter().get(0)) : UUID.randomUUID().toString().toLowerCase());
                ...
                case C:
                    ...
                    return c;
                case QTY: // Create a quantity. Parameters = (text) or (value, unit, [system, code]) where text is the natural representation e.g. [comparator]value[space]unit
                    Quantity quantity = new Quantity();
                    List<StructureMapGroupRuleTargetParameterComponent> parameterList = tgt.getParameter();
                    if ( parameterList.size()==1 ){
                        // text parsing required
                        throw new FHIRException("Rule \""+ruleId+"\": Transform engine has not implemented QTY transfer based on text" );
                    }
                    if ( parameterList.size()>=1 ){
                        quantity.setValueElement(parameterList.get(0).getValueDecimalType());
                    }
                    if ( parameterList.size()>=2 ){
                        quantity.setUnit( parameterList.get(1).getValueStringType().asStringValue() );
                    }
                    if ( parameterList.size()>=3 ){
                        quantity.setSystem( parameterList.get(2).getValueStringType().asStringValue() );
                    }
                    if ( parameterList.size()>=4 ){
                        quantity.setCode( parameterList.get(3).getValueStringType().asStringValue() );
                    }
                    return quantity;
                default:
    ...
    private String getParamStringNoNull(org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, StructureMapGroupRuleTargetParameterComponent parameter, String message) throws FHIRException {
    ...
    private String getParamString(org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, StructureMapGroupRuleTargetParameterComponent parameter) throws DefinitionException {
        Base b = getParam(vars, parameter);
    ...
    private Base getParam(org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, StructureMapGroupRuleTargetParameterComponent parameter) throws DefinitionException {
        Type p = parameter.getValue();
        if (!(p instanceof IdType))
            return p;
        else {
            String n = ((IdType) p).asStringValue();
            Base b = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, n);
            if (b == null)
                b = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, n);
            if (b == null)
    ...
    private Base translate(org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, org.hl7.fhir.dstu3.utils.StructureMapUtilities.Variables vars, List<StructureMapGroupRuleTargetParameterComponent> parameter) throws FHIRException {
    ...
    public Base translate(org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, Base source, String conceptMapUrl, String fieldToReturn) throws FHIRException {
        ...
        if (conceptMapUrl.equals("http://hl7.org/fhir/ConceptMap/special-oid2uri")) {
            ...
            if (cmap == null) {
                ...
                List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.SourceElementComponentWrapper> list = new ArrayList<org.hl7.fhir.dstu3.utils.StructureMapUtilities.SourceElementComponentWrapper>();
                for (ConceptMapGroupComponent g : cmap.getGroup()) {
                    for (SourceElementComponent e : g.getElement()) {
                        if (!src.hasSystem() && src.getCode().equals(e.getCode()))
                            list.add(new org.hl7.fhir.dstu3.utils.StructureMapUtilities.SourceElementComponentWrapper(g, e));
    ...
    public class VariableForProfiling {
        private org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode;
        private String name;
        private org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType property;

        public VariableForProfiling(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name, org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType property) {
            super();
            this.mode = mode;
            this.name = name;
        ...
        public org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType getProperty() {
            return property;
        }
        public String summary() {
    ...
    public class VariablesForProfiling {
        private List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling> list = new ArrayList<org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling>();
        ...
        public void add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name, String path, Property property, TypeDetails types) {
            add(mode, name, new org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType(path, property, null, types));
        }

        public void add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name, String path, Property baseProperty, Property profileProperty, TypeDetails types) {
            add(mode, name, new org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType(path, baseProperty, profileProperty, types));
        }

        public void add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name, org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType property) {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling vv = null;
            for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling v : list)
                if ((v.mode == mode) && v.getName().equals(name))
                    vv = v;
            if (vv != null)
                list.remove(vv);
            list.add(new org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling(mode, name, property));
        }

        public org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling copy(boolean optional, boolean repeating) {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling result = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling(optional, repeating);
            result.list.addAll(list);
            return result;
        }

        public org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling copy() {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling result = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling(optional, repeating);
            result.list.addAll(list);
            return result;
        }

        public org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, String name) {
            if (mode == null) {
                for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling v : list)
                    if ((v.mode == org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT) && v.getName().equals(name))
                        return v;
                for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling v : list)
                    if ((v.mode == org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT) && v.getName().equals(name))
                        return v;
            }
            for (org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling v : list)
                if ((v.mode == mode) && v.getName().equals(name))
     ...
     * @throws Exception
     */
    public org.hl7.fhir.dstu3.utils.StructureMapUtilities.StructureMapAnalysis analyse(Object appInfo, StructureMap map) throws Exception {
        ids.clear();
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.StructureMapAnalysis result = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.StructureMapAnalysis();
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext(appInfo);
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling(false, false);
        StructureMapGroupComponent start = map.getGroup().get(0);
        for (StructureMapGroupInputComponent t : start.getInput()) {
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType ti = resolveType(map, t.getType(), t.getMode());
            if (t.getMode() == StructureMapInputMode.SOURCE)
                vars.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, t.getName(), ti);
            else
                vars.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, t.getName(), createProfile(map, result.profiles, ti, start.getName(), start));
        }
    ...
    private void analyseGroup(String indent, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupComponent group, org.hl7.fhir.dstu3.utils.StructureMapUtilities.StructureMapAnalysis result) throws Exception {
        ...
        for (StructureMapGroupInputComponent inp : group.getInput()) {
            if (inp.getMode() == StructureMapInputMode.SOURCE)
                noteInput(vars, inp, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, xs);
            if (inp.getMode() == StructureMapInputMode.TARGET)
                noteInput(vars, inp, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, xt);
        }
        for (StructureMapGroupRuleComponent r : group.getRule()) {
    ...
    private void noteInput(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupInputComponent inp, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode mode, XhtmlNode xs) {
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling v = vars.get(mode, inp.getName());
        if (v != null)
            xs.addText("Input: "+v.property.getPath());
    }

    private void analyseRule(String indent, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupComponent group, StructureMapGroupRuleComponent rule, org.hl7.fhir.dstu3.utils.StructureMapUtilities.StructureMapAnalysis result) throws Exception {
        log(indent+"Analyse rule : "+rule.getName());
        XhtmlNode tr = result.summary.addTag("tr");
        XhtmlNode xs = tr.addTag("td");
        XhtmlNode xt = tr.addTag("td");

        org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling srcVars = vars.copy();
        if (rule.getSource().size() != 1)
            throw new Exception("Rule \""+rule.getName()+"\": not handled yet");
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling source = analyseSource(rule.getName(), context, srcVars, rule.getSourceFirstRep(), xs);

        org.hl7.fhir.dstu3.utils.StructureMapUtilities.TargetWriter tw = new org.hl7.fhir.dstu3.utils.StructureMapUtilities.TargetWriter();
        for (StructureMapGroupRuleTargetComponent t : rule.getTarget()) {
...
//    }
    ...
    public class TargetWriter {
        ...
        private List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.StringPair> assignments = new ArrayList<org.hl7.fhir.dstu3.utils.StructureMapUtilities.StringPair>();
        private List<org.hl7.fhir.dstu3.utils.StructureMapUtilities.StringPair> keyProps = new ArrayList<org.hl7.fhir.dstu3.utils.StructureMapUtilities.StringPair>();
        ...
        public void valueAssignment(String context, String desc) {
            assignments.add(new org.hl7.fhir.dstu3.utils.StructureMapUtilities.StringPair(context, desc));
            txt.append(desc);
        }

        public void keyAssignment(String context, String desc) {
            keyProps.add(new org.hl7.fhir.dstu3.utils.StructureMapUtilities.StringPair(context, desc));
            txt.append(desc);
        }
    ...
    private org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling analyseSource(String ruleId, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupRuleSourceComponent src, XhtmlNode td) throws Exception {
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling var = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, src.getContext());
        if (var == null)
            throw new FHIRException("Rule \""+ruleId+"\": Unknown input variable "+src.getContext());
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType prop = var.getProperty();
        ...
        if (src.hasElement()) {
            ...
            if (element.getDefinition().getMax().equals("*"))
                repeating = true;
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling result = vars.copy(optional, repeating);
            ...
            if (src.hasVariable())
                result.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, src.getVariable(), new org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType(prop.getPath()+"."+src.getElement(), element, null, type));
            return result;
        } else {
    ...
    private void analyseTarget(String ruleId, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMap map, StructureMapGroupRuleTargetComponent tgt, String tv, org.hl7.fhir.dstu3.utils.StructureMapUtilities.TargetWriter tw, List<StructureDefinition> profiles, String sliceName) throws Exception {
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling var = null;
        if (tgt.hasContext()) {
            var = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, tgt.getContext());
            if (var == null)
        ...
        org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType prop = updateProfile(var, tgt.getElement(), type, map, profiles, sliceName, fixed, tgt);
        if (tgt.hasVariable())
            if (tgt.hasElement())
                vars.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, tgt.getVariable(), prop);
            else
                vars.add(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, tgt.getVariable(), prop);
    }
    ...
    private boolean isSignificantElement(org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType property, String element) {
    ...
    private org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType updateProfile(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling var, String element, TypeDetails type, StructureMap map, List<StructureDefinition> profiles, String sliceName, Type fixed, StructureMapGroupRuleTargetComponent tgt) throws FHIRException {
        if (var == null) {
            ...
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType pn = createProfile(map, profiles, new org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType(sdn.getId(), new Property(worker, edn, sdn), null, type), sliceName, tgt);
...
//      }
            ...
            return new org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType(var.property.path+"."+element, pc, new Property(worker, ednew, sd), type);
        }
    }
    ...
    private TypeDetails analyseTransform(org.hl7.fhir.dstu3.utils.StructureMapUtilities.TransformContext context, StructureMap map, StructureMapGroupRuleTargetComponent tgt, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling var, org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars) throws FHIRException {
        switch (tgt.getTransform()) {
            case CREATE :
...
////  throw new Error("Transform "+tgt.getTransform().toCode()+" not supported yet");
            ...
            case REFERENCE :
                org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling vrs = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, getParamId(vars, tgt.getParameterFirstRep()));
                if (vrs == null)
...
////    throw new FHIRException("Transform engine cannot point at an element of type "+b.fhirType());
    ...
    private String getParamString(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupRuleTargetParameterComponent parameter) {
        Type p = parameter.getValue();
    ...
    private String getParamId(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupRuleTargetParameterComponent parameter) {
        Type p = parameter.getValue();
        if (p == null || !(p instanceof IdType))
            return null;
        return p.primitiveValue();
    ...
    private boolean isParamId(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupRuleTargetParameterComponent parameter) {
        Type p = parameter.getValue();
        if (p == null || !(p instanceof IdType))
            return false;
    ...
    private TypeDetails getParam(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariablesForProfiling vars, StructureMapGroupRuleTargetParameterComponent parameter) throws DefinitionException {
        Type p = parameter.getValue();
        if (!(p instanceof IdType))
            return new TypeDetails(CollectionStatus.SINGLETON, "http://hl7.org/fhir/StructureDefinition/"+p.fhirType());
        else {
            String n = ((IdType) p).asStringValue();
            org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableForProfiling b = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.INPUT, n);
            if (b == null)
                b = vars.get(org.hl7.fhir.dstu3.utils.StructureMapUtilities.VariableMode.OUTPUT, n);
            if (b == null)
                throw new DefinitionException("Variable "+n+" not found ("+vars.summary()+")");
    ...
    private org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType createProfile(StructureMap map, List<StructureDefinition> profiles, org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType prop, String sliceName, Base ctxt) throws DefinitionException {
    ...
    private org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType resolveType(StructureMap map, String type, StructureMapInputMode mode) throws Exception {
        for (StructureMapStructureComponent imp : map.getStructure()) {
            if ((imp.getMode() == StructureMapModelMode.SOURCE && mode == StructureMapInputMode.SOURCE) ||
                ...
                if (sd.getId().equals(type)) {
                    return new org.hl7.fhir.dstu3.utils.StructureMapUtilities.PropertyWithType(sd.getType(), new Property(worker, sd.getSnapshot().getElement().get(0), sd), null, new TypeDetails(CollectionStatus.SINGLETON, sd.getUrl()));
                }
            }
        }
    ...
    public StructureMap generateMapFromMappings(StructureDefinition sd) throws IOException, FHIRException {
        ...
        if (prefix == null || suffix == null)
            return null;
        // we buildQuestionnaire this by text. Any element that has a mapping, we put it's mappings inside it....
        StringBuilder b = new StringBuilder();
        b.append(prefix);
