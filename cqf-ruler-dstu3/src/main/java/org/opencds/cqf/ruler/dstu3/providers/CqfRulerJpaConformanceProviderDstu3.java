...
public class CqfRulerJpaConformanceProviderDstu3 extends JpaConformanceProviderDstu3 {
    ...
    public CapabilityStatement getServerConformance(HttpServletRequest theRequest, RequestDetails theRequestDetails) {
        ...
        Extension softwareModuleVersionExtension = new Extension().setUrl("version").setValue(new StringType(CqfRulerJpaConformanceProviderDstu3 .class.getPackage().getImplementationVersion()));
