...
public class StarterJpaConfig {
	...
	private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(org.opencds.cqf.jpa.starter.common.StarterJpaConfig.class);
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource myDataSource, ConfigurableListableBeanFactory myConfigurableListableBeanFactory, FhirContext theFhirContext) {
		...
		retVal.setJpaProperties(org.opencds.cqf.jpa.starter.util.EnvironmentHelper.getHibernateProperties(configurableEnvironment, myConfigurableListableBeanFactory));
		return retVal;
	}
	...
	public RepositoryValidatingInterceptor repositoryValidatingInterceptor(org.opencds.cqf.jpa.starter.common.validation.IRepositoryValidationInterceptorFactory factory) {
		return factory.buildUsingStoredStructureDefinitions();
	}

	@Bean
	public LoggingInterceptor loggingInterceptor(org.opencds.cqf.jpa.starter.AppProperties appProperties) {
	...
	@Primary
	@Conditional(org.opencds.cqf.jpa.starter.annotations.OnImplementationGuidesPresent.class)
	public IPackageInstallerSvc packageInstaller(org.opencds.cqf.jpa.starter.AppProperties appProperties, JobDefinition<ReindexJobParameters> reindexJobParametersJobDefinition, JobDefinitionRegistry jobDefinitionRegistry, IPackageInstallerSvc packageInstallerSvc)
	{
	...
	@Bean
	@Conditional(org.opencds.cqf.jpa.starter.annotations.OnCorsPresent.class)
