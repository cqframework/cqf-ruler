...
public class CodeSystemProviderIT implements TesterUtilities {
    ...
    public void testDSTU3RxNormCodeSystemUpdateById() throws IOException {       
        log.info("Beginning Test R4 RxNorm CodeSystemUpdate");

        ValueSet vs = (ValueSet) loadResource(CodeSystemProviderIT.class.getResource("valueset/AntithromboticTherapy.json").getPath(), ourCtx, myDaoRegistry);
        ...
        log.info("Finished Test R4 RxNorm CodeSystemUpdate");
    }
    ...
    public void testDSTU3ICD10PerformCodeSystemUpdateByList() throws IOException {
        ...
        ValueSet vs = (ValueSet) loadResource(CodeSystemProviderIT.class.getResource("valueset/AllPrimaryandSecondaryCancer.json").getPath(), ourCtx, myDaoRegistry);
        myDaoRegistry.getResourceDao(ValueSet.class).update(vs);
