...
public interface OperatorUtilities extends ResolutionUtilities {
	...
	Logger ourLog = LoggerFactory.getLogger(OperatorUtilities.class);
	 ...
	 */
	default Date resolveRequestDate(String date, boolean start) {
	 ...
	 * @return the FHIR period date as a java.util.Date type
	 */
	default String getFullUrl(String serverAddress, String fhirType, String elementId) {
	...
	// default <ResourceType extends IBaseResource> void ensurePatient(String
	// patientRef, DaoRegistry theRegistry, Class<ResourceType> theResourceType) {
	...
	// default <ResourceType extends IBaseResource> List<Reference>
	// getPatientListFromSubject(String theSubject, DaoRegistry theRegistry,
	// Class<ResourceType> thePatientType, Class<ResourceType> theGroupType) {
