...
public interface ExecutionUtilities {
    ...
    default IBaseResource bundle(FhirContext fhirContext, Context executionContext, String... expressionNames) {
        return bundle(fhirContext, executionContext, null, expressionNames);
    }
    // Adds the resources returned from the given expressions to a bundle
    @SuppressWarnings("unchecked")
    default IBaseResource bundle(FhirContext fhirContext, Context executionContext, String theServerBase, String... expressionNames) {
    ...
    default IBaseResource bundle(Iterable<IBaseResource> resources, FhirContext fhirContext) {
        return bundle(resources, fhirContext, null);
    }

    default IBaseResource bundle(Iterable<IBaseResource> resources, FhirContext fhirContext, String theServerBase) {
        IVersionSpecificBundleFactory bundleFactory = fhirContext.newBundleFactory();
