...
public class RAConstants {
	...
	public static final Extension SUSPECT_TYPE_HISTORIC_EXT = new Extension().setUrl(SUSPECT_TYPE_URL).setValue(HISTORIC_CONCEPT);
	public static final Extension SUSPECT_TYPE_SUSPECTED_EXT = new Extension().setUrl(SUSPECT_TYPE_URL).setValue(SUSPECTED_CONCEPT);
	public static final Extension SUSPECT_TYPE_NET_NEW_EXT = new Extension().setUrl(SUSPECT_TYPE_URL).setValue(NET_NEW_CONCEPT);
	// Evidence Status
