 ...
 */
public class CqlExecutionProvider implements OperationProvider, OperatorUtilities, LibraryUtilities, ExecutionUtilities {
    ...
    public Bundle evaluate(RequestDetails theRequest,
        ...
        try {
            translator = this.getTranslator(code, getLibraryManager(this.libraryResolutionProvider), modelManager);
