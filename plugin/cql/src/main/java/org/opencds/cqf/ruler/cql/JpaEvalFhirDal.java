...
public class JpaEvalFhirDal implements FhirDal {
	protected final DaoRegistry daoRegistry;
	protected final RequestDetails requestDetails;

	public JpaEvalFhirDal(DaoRegistry daoRegistry) {
		this(daoRegistry, null);
	}

	public JpaEvalFhirDal(DaoRegistry daoRegistry, RequestDetails requestDetails) {
