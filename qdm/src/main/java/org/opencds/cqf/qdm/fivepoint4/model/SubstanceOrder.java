...
public abstract class SubstanceOrder extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof SubstanceOrder)
        {
            SubstanceOrder substanceOrder = (SubstanceOrder) other;
            super.copy(substanceOrder);
            setAuthorDatetime(substanceOrder.getAuthorDatetime());
            setReason(substanceOrder.getReason());
            setDosage(substanceOrder.getDosage());
            setSupply(substanceOrder.getSupply());
            setFrequency(substanceOrder.getFrequency());
            setRefills(substanceOrder.getRefills());
            setRoute(substanceOrder.getRoute());
            setNegationRationale(substanceOrder.getNegationRationale());
        }
        else
        {
