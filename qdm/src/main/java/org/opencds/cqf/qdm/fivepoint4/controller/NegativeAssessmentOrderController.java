...
public class NegativeAssessmentOrderController implements Serializable
{
    ...
    public List<NegativeAssessmentOrder> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            NegativeAssessmentOrder exampleType = new NegativeAssessmentOrder();
            Id pId = new Id();
            ...
            Example<NegativeAssessmentOrder> example = Example.of(exampleType, matcher);
