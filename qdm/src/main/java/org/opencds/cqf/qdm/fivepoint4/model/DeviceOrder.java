...
public abstract class DeviceOrder extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof DeviceOrder)
        {
            DeviceOrder encounterPerformed = (DeviceOrder) other;
            ...
            setReason(encounterPerformed.getReason());
        }
        else
        {
