...
public abstract class LaboratoryTestRecommended extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof LaboratoryTestRecommended)
        {
            LaboratoryTestRecommended laboratoryTestRecommended = (LaboratoryTestRecommended) other;
            super.copy(laboratoryTestRecommended);
            setAuthorDatetime(laboratoryTestRecommended.getAuthorDatetime());
            setReason(laboratoryTestRecommended.getReason());
            setNegationRationale(laboratoryTestRecommended.getNegationRationale());
        }
        else
        {
