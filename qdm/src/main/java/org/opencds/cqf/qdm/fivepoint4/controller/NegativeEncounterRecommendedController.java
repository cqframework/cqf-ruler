...
public class NegativeEncounterRecommendedController implements Serializable
{
    ...
    public List<NegativeEncounterRecommended> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            NegativeEncounterRecommended exampleType = new NegativeEncounterRecommended();
            Id pId = new Id();
            ...
            Example<NegativeEncounterRecommended> example = Example.of(exampleType, matcher);
