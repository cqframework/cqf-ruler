...
public class PositiveSubstanceRecommendedController implements Serializable
{
    ...
    public List<PositiveSubstanceRecommended> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveSubstanceRecommended exampleType = new PositiveSubstanceRecommended();
            Id pId = new Id();
            ...
            Example<PositiveSubstanceRecommended> example = Example.of(exampleType, matcher);
