...
public abstract class EncounterRecommended extends BaseType implements Serializable
{
   ...
   @ElementCollection
    ...
    {
        if (other instanceof EncounterRecommended)
        {
            EncounterRecommended encounterRecommended = (EncounterRecommended) other;
            super.copy(encounterRecommended);
            setAuthorDatetime(encounterRecommended.getAuthorDatetime());
            setReason(encounterRecommended.getReason());
            setFacilityLocation(encounterRecommended.getFacilityLocation());
            setNegationRationale(encounterRecommended.getNegationRationale());
        }
        else
        {
