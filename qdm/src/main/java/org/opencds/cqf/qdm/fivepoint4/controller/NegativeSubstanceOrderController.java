...
public class NegativeSubstanceOrderController implements Serializable
{
    ...
    public List<NegativeSubstanceOrder> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            NegativeSubstanceOrder exampleType = new NegativeSubstanceOrder();
            Id pId = new Id();
            ...
            Example<NegativeSubstanceOrder> example = Example.of(exampleType, matcher);
