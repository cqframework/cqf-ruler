...
public class PositiveDeviceOrderController implements Serializable
{
    ...
    public List<PositiveDeviceOrder> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            PositiveDeviceOrder exampleType = new PositiveDeviceOrder();
            Id pId = new Id();
            ...
            Example<PositiveDeviceOrder> example = Example.of(exampleType, matcher);
