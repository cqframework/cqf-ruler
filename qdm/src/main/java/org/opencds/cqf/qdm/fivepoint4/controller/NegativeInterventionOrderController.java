...
public class NegativeInterventionOrderController implements Serializable
{
    ...
    public List<NegativeInterventionOrder> getAll(@RequestParam(name = "patientId", required = false) String patientId)
    {
        if (patientId == null)
        {
            ...
            NegativeInterventionOrder exampleType = new NegativeInterventionOrder();
            Id pId = new Id();
            ...
            Example<NegativeInterventionOrder> example = Example.of(exampleType, matcher);
