...
public abstract class SubstanceAdministered extends BaseType implements Serializable
{
    ...
    {
        if (other instanceof SubstanceAdministered)
        {
            SubstanceAdministered substanceAdministered = (SubstanceAdministered) other;
            super.copy(substanceAdministered);
            setAuthorDatetime(substanceAdministered.getAuthorDatetime());
            setDosage(substanceAdministered.getDosage());
            setFrequency(substanceAdministered.getFrequency());
            setRoute(substanceAdministered.getRoute());
            setNegationRationale(substanceAdministered.getNegationRationale());
        }
        else
        {
