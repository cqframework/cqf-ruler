package org.opencds.cqf.stu3.servlet;
...
import org.opencds.cqf.stu3.helpers.LibraryHelper;
import org.opencds.cqf.stu3.providers.FHIRPlanDefinitionResourceProvider;
import org.opencds.cqf.stu3.providers.JpaDataProvider;
...
public class CdsHooksServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try {
            ...
            LibraryLoader libraryLoader = LibraryHelper.createLibraryLoader((org.opencds.cqf.stu3.providers.LibraryResourceProvider) provider.resolveResourceProvider("Library"));
            Library library = LibraryHelper.resolvePrimaryLibrary(planDefinition, libraryLoader, (org.opencds.cqf.stu3.providers.LibraryResourceProvider) provider.resolveResourceProvider("Library"));
